module.exports = {
    getGroupChat: async (req, res) => {
        ...
        const { id } = req.params
        const groupChat = await db.group.get_group_chat({ id })
    ...
    createGroup: async (req, res) => {
        ...
        const db = req.app.get('db')
        const newGroup = await db.group.create_group({ name })
    ...
    getGroups: async (req, res) => {
        ...
        const db = req.app.get('db')
        const groups = await db.group.get_all_user_groups({ user_id })
